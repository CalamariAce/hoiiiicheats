...
### province resource production: Multiply resource production for all controlled provinces.
...
### province improvement levels: Set improvement levels for all controlled provinces.
Default level is 10.
...
### nation multiply value scripts: Multiply some value for a nation.
...
### nation set value scripts: Set some value for a nation.
...
| | [Source](https://forum.paradoxplaza.com/forum/index.php?threads/a-list-of-countries-tags.476342/) |